...
function PlaceholderScreen({ title }: { title: string }) {
  return (
    <div className="h-full w-full p-8" style={{ backgroundColor: "#08111F" }}>
      ...
      >
        <div className="text-[11px] font-bold tracking-[0.22em] uppercase mb-3">{title}</div>
  ...
  return (
    ...
    >
        ...
        <div className="px-5 h-[58px] flex items-center justify-between gap-4">
              ...
              {MAIN_TABS.map((tab) => {
                ...
                return (
                  <button
                    ...
                    style={
                      active
                        ? { backgroundColor: "#132845", color: "#F8FAFC", border: "1px solid rgba(201,168,76,0.25)" }
                        : { backgroundColor: "transparent", color: "#8A9BB5", border: "1px solid transparent" }
                    }
                  >
                    {tab}
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              style={{ color: "#C9A84C", backgroundColor: "rgba(201,168,76,0.06)", border: "1px solid rgba(201,168,76,0.22)" }}
            >
              APPROVAL REQUIRED
            </button>
            <button
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-[11px] font-bold tracking-wide"
              style={{ color: "#FF5F5F", backgroundColor: "#0D1B2E", border: "1px solid rgba(255,95,95,0.28)" }}
            >
              REPORTS
            </button>
            <SystemHealthPanel />
      ...
      <main className={`flex-1 ${mainOverflowClass}`}>
        ...
        {activeTab === "QUEUE" && <BoysQueuePanel onPendingCountChange={setPendingCount} />}
