...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050B14] p-8 font-sans text-gray-200">
      ...
      <main className="grid grid-cols-12 gap-6">
        <section className="col-span-8 bg-[#0D1B2E] border border-[#1B2A4A] rounded-xl p-8 min-h-[400px]">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            ...
            to diagnose integration failures or service degradation.
          </p>
        </section>
        ...
        <aside className="col-span-4 space-y-6">
          <div className="bg-[#111D30] border border-[#1B2A4A] p-4 rounded-xl">
            ...
            <div className="grid grid-cols-1 gap-2">
               <button className="text-left px-3 py-2 text-xs rounded bg-[#1B2A4A] text-white">Flush Cache</button>
               <button className="text-left px-3 py-2 text-xs rounded bg-[#1B2A4A] text-white">Restart API Node</button>
            </div>
          </div>
        </aside>
      </main>
