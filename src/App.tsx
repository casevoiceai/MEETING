...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="text-sm font-bold tracking-widest uppercase mr-6"
          style={{ color: "#C9A84C" }}
        >
          MyStatement_AI
        </span>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        {view === "email" && (
          <EmailView onPendingChange={setPendingApprovalCount} />
        )}
        ...
        {view === "vault" && (
          <VaultView
            onNavigateLinked={handleLinkedNavigation}
            linkedTarget={
              linkedNavTarget?.type === "file" ||
              linkedNavTarget?.type === "note"
                ? linkedNavTarget
                : undefined
            }
          />
        ...
        {view === "integrations" && (
          <IntegrationsView onPendingChange={setPendingApprovalCount} />
        )}

        {view === "source-of-truth" && (
          <SourceOfTruthPanel sessionKey={sessionKey} />
        )}
